(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://nahombefekadu.github.io/Notes/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://nahombefekadu.github.io/Notes/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://nahombefekadu.github.io/Notes/assets/css/just-the-docs-' + theme + ".css"
      );
    };
